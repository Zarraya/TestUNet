...
internal struct NullableCornerRadius {
  ...
  public static implicit operator System.Nullable<CornerRadius>(NullableCornerRadius n) {
    return n.HasValue ? new System.Nullable<CornerRadius>(n.Value) : new System.Nullable<CornerRadius>();
  }

  public static implicit operator NullableCornerRadius(System.Nullable<CornerRadius> n) {
