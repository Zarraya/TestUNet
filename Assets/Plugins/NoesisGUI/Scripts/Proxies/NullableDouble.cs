...
internal struct NullableDouble {
  ...
  public static implicit operator System.Nullable<double>(NullableDouble n) {
    return n.HasValue ? new System.Nullable<double>(n.Value) : new System.Nullable<double>();
  }

  public static implicit operator NullableDouble(System.Nullable<double> n) {
