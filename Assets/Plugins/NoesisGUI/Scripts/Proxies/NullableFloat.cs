...
internal struct NullableFloat {
  ...
  public static implicit operator System.Nullable<float>(NullableFloat n) {
    return n.HasValue ? new System.Nullable<float>(n.Value) : new System.Nullable<float>();
  }

  public static implicit operator NullableFloat(System.Nullable<float> n) {
