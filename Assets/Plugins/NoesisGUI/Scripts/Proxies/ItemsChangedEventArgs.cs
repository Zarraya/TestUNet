...
public class ItemsChangedEventArgs : EventArgs {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          if (Noesis.Extend.Initialized) { NoesisGUI_PINVOKE.delete_ItemsChangedEventArgs(swigCPtr);}
        }
  ...
  public System.Collections.Specialized.NotifyCollectionChangedAction Action {
    get {
      return (System.Collections.Specialized.NotifyCollectionChangedAction)GetActionHelper();
    }
  }
  ...
  private int GetActionHelper() {
    int ret = (int)NoesisGUI_PINVOKE.ItemsChangedEventArgs_GetActionHelper(swigCPtr);
