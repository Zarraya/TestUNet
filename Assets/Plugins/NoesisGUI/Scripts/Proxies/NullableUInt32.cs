...
internal struct NullableUInt32 {
  ...
  public static implicit operator System.Nullable<uint>(NullableUInt32 n) {
    return n.HasValue ? new System.Nullable<uint>(n.Value) : new System.Nullable<uint>();
  }

  public static implicit operator NullableUInt32(System.Nullable<uint> n) {
