...
internal struct NullableKeyTime {
  ...
  public static implicit operator System.Nullable<KeyTime>(NullableKeyTime n) {
    return n.HasValue ? new System.Nullable<KeyTime>(n.Value) : new System.Nullable<KeyTime>();
  }

  public static implicit operator NullableKeyTime(System.Nullable<KeyTime> n) {
