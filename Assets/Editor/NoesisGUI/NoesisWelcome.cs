...
public class NoesisWelcome : EditorWindow
{
    ...
    void OnInspectorUpdate()
    {
        ...
        if (_banner == null)
        {
            _banner = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/banner.png", typeof(Texture2D));
            if (_banner != null) doRepaint = true;
        }

        if (_bannerStyle.normal.background == null)
        {
            _bannerStyle.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/banner_bg.png", typeof(Texture2D));
            if (_bannerStyle.normal.background != null) doRepaint = true;
        }

        if (_icon0 == null)
        {
            _icon0 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/ico_release.png", typeof(Texture2D));
            if (_banner != null) doRepaint = true;
        }

        if (_icon1 == null)
        {
            _icon1 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/ico_tutorials.png", typeof(Texture2D));
            if (_banner != null) doRepaint = true;
        }

        if (_icon2 == null)
        {
            _icon2 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/ico_doc.png", typeof(Texture2D));
            if (_banner != null) doRepaint = true;
        }

        if (_icon3 == null)
        {
            _icon3 = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Editor/NoesisGUI/ico_forums.png", typeof(Texture2D));
            if (_banner != null) doRepaint = true;
        }
